      ...
      <Panel className="p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-slate-200">Credential encryption</p>
              <p className="mt-1 text-xs leading-relaxed text-slate-500">
                Passwords, 2FA seeds and recovery emails are sealed with AES-256-GCM. They are only decrypted when you explicitly
                reveal them.
              </p>
            </div>
          </div>
